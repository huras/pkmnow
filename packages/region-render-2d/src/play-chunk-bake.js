...
import { getMicroTile, MACRO_TILE_STRIDE, LAND_STEPS, foliageDensity } from 'region-map-gen/chunking.js';
import { imageCache } from 'region-terrain-tiles/image-cache.js';
import { validScatterOriginMicro } from 'region-terrain-tiles/scatter-pass2-debug.js';
import { getRoleForCell, seededHash, parseShape, terrainRoleAllowsScatter2CContinuation } from 'region-map-gen/tessellation-logic.js';
import { drawTerrainCellFromSheet, getConcConvATerrainTileSpec } from './conc-conv-a-terrain-blit.js';
import { OBJECT_SETS, TERRAIN_SETS } from 'region-terrain-tiles/tessellation-data.js';
import { TessellationEngine } from 'region-terrain-tiles/tessellation-engine.js';
...
import { hasScatterItemKeyOverride } from 'region-terrain-tiles/scatter-item-override.js';
