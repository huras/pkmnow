...
export const POKEMON_CONFIG = {
  ...
  444: { name: 'Gabite', types: ['dragon', 'ground'], heightTiles: 4.2, baseSpeed: 82 },
  445: { name: 'Garchomp', types: ['dragon', 'ground'], heightTiles: 5.3, baseSpeed: 102 },
  ...
  450: { name: 'Hippowdon', types: ['ground'], heightTiles: 5.5, baseSpeed: 47 },
