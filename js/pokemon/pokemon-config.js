...
export const POKEMON_CONFIG = {
  ...
  7: { name: 'Squirtle', types: ['water'], heightTiles: 2, baseSpeed: 43 },
  8: { name: 'Wartortle', types: ['water'], heightTiles: 3.5, baseSpeed: 58 },
  9: { name: 'Blastoise', types: ['water'], heightTiles: 3.5, baseSpeed: 78 },
  10: { name: 'Caterpie', types: ['bug'], heightTiles: 2, baseSpeed: 45 },
  11: { name: 'Metapod', types: ['bug'], heightTiles: 2.1, baseSpeed: 30 },
  12: { name: 'Butterfree', types: ['bug', 'flying'], heightTiles: 5, baseSpeed: 70 },
  ...
  31: { name: 'Nidoqueen', types: ['poison', 'ground'], heightTiles: 4.2, baseSpeed: 76 },
  32: { name: 'Nidoran♂', types: ['poison'], heightTiles: 2.5, baseSpeed: 50 },
  33: { name: 'Nidorino', types: ['poison'], heightTiles: 3.5, baseSpeed: 65 },
  34: { name: 'Nidoking', types: ['poison', 'ground'], heightTiles: 4.4, baseSpeed: 85 },
  35: { name: 'Clefairy', types: ['normal'], heightTiles: 2.5, baseSpeed: 35 },
  36: { name: 'Clefable', types: ['normal'], heightTiles: 3.5, baseSpeed: 60 },
  37: { name: 'Vulpix', types: ['fire'], heightTiles: 2.5, baseSpeed: 65 },
  38: { name: 'Ninetales', types: ['fire'], heightTiles: 3.5, baseSpeed: 100 },
  ...
  96: { name: 'Drowzee', types: ['psychic'], heightTiles: 3.1, baseSpeed: 42 },
  97: { name: 'Hypno', types: ['psychic'], heightTiles: 3.5, baseSpeed: 67 },
  ...
  120: { name: 'Staryu', types: ['water'], heightTiles: 2.5, baseSpeed: 85 },
