...
const BUILDING_GROUND_SHADOW_TUNING = {
  alpha: 0.22,
  scaleY: 0.34,
  offsetXTiles: 0.08,
  offsetYTiles: 0.08,
...
const POKEMON_ELLIPSE_SHADOW_TUNING = {
  alphaBase: 0.54,
  alphaMin: 0.06,
  alphaMax: 0.34,
  widthMul: 0.4,
 ...
 */
function drawGroundSilhouetteShadow(ctx, meta, snapPx, tileW, tileH, tuning, dynamics) {
 ...
 * @param {any} settings
 */
function resolveDynamicShadowDynamics(settings) {
 ...
 */
function shadowPolicyByType(item) {
 ...
 */
function getBuildingGroundShadowMeta(item, imageCache, tileW, tileH, snapPx, frameShadowBudget) {
 ...
 */
function drawPlayerFlashHoldAura(ctx, item, flashVisual, tileW, pxT0, pxH) {
 ...
 */
function drawVegetationHybridShadow(ctx, item, options) {
  const {
    tileW,
    tileH,
    snapPx,
 ...
 */
function drawScatterGroundDetailSilhouetteShadow(ctx, item, tileW, tileH, snapPx, imageCache, shadowDynamics, time) {
