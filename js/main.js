...
function enterPlayMode(gx, gy) {
  ...
  infoBar.innerHTML =
    "<b style='color:#fff'>WASD / setas · duplo toque na mesma direção = correr · ESC = sair.</b><br><span style='color:#cfe7ff;font-size:0.88rem'>Mouse: LMB = field move selecionado (Cut tem combo de 3 cliques; segure e solte LMB para versão carregada com Charge anim + movimento lento). RMB = 2º golpe do moveset, segure RMB = carregado (Ember/água etc.), Psybeam no 2º slot: segure RMB = orbe rosa e solte = raio longo, Left Ctrl+LMB 3º golpe, Left Ctrl+RMB 4º golpe, MMB Ultimate. Segure 1 = field move wheel (Tackle / Cut / Strength). Hotkeys: 2 Flamethrower · … · - Silk Shoot. Social: Numpad 1-9. Debug: Ctrl+RMB.</span>";
